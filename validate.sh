...
curl -s -S -O "http://ocds.open-contracting.org/standard/r/1__0__2/release-package-schema.json"
curl -s -S -O "http://ocds.open-contracting.org/standard/r/1__0__2/record-package-schema.json"
curl -s -S -O "http://ocds.open-contracting.org/standard/r/1__0__2/release-schema.json"
