    ...
    try:
        for contract in release['contracts']:
            for transaction in contract['implementation']['transactions']:
                transaction['payer'] = {"id": transaction['providerOrganization']['scheme'] + "-" + transaction['providerOrganization']['id'], "name":transaction['providerOrganization']['legalName'] }
                transaction['payee'] = {"id": transaction['receiverOrganization']['scheme'] + "-" + transaction['receiverOrganization']['id'], "name":transaction['receiverOrganization']['legalName'] }
